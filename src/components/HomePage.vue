                ...
                <div class="central-box-wrapper">
                    <div class="central-box">
                        <div class="logo-section">
                            <img class="logo-img" src="../assets/X-large.png">
                        </div>
        ...
        <div class="flex-row">
            <div class="info-section">
                <div class="info-inner">
                    ...
                    <div class="bar"></div>
                    <div class="text">
                        Health<span style="font-weight: 700;">STLX</span> is a one-day healthcare summit aimed at bringing together leaders and innovators to explore the use of data and design in addressing some of today's greatest challenges through a local St. Louis lens.
                    </div>
                    <!-- <div class="note">
...
<style lang="less">
    ...
    .first-section {
        ...
        width: 100vw;
        color: #fff;
        background: url("../assets/healthstlx-mockbg.jpg") no-repeat center center fixed;
