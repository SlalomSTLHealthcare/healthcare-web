...
<el-row>
  ...
  <el-row class="session"v-else="sessionType === 'Panel'" style="margin-top: 20px;">
    <el-card shadow="hover" class="panelCard" v-for="session in sessionData" v-if="session.session_type == sessionType">
      ...
      <p class="description">This panel discussion will feature the following St. Louis thought-leaders: Melodie Donatelli, Dr. Leslie McIntosh Borrelli, Dr. J. Gavin Helton, Dr. Alexander Garza, and Shea Long.</p>
    </el-card>
  </el-row>
</el-row>
</template>
