            ...
            <div class="sticky-helper">
                <div class="central-box-wrapper">
                    <div class="central-box">
                        ...
                        <el-button class="googleButton" plain round v-on:click="googleDoc">Review Proposed Solutions</el-button>
                    </div>
                </div>
            </div>
  ...
  methods: {
    googleDoc() {
      window.location.href =
        "https://drive.google.com/drive/folders/18oV4dkUIiUxOum2sQjNlAMVSRjtYIiix?usp=sharing";
    },
    handleRegisterClick() {
...
.flex-row {
  ...
  .quote-section {
    ...
    .quote-inner {
      ...
      padding: 0 10vw;
      z-index: 2;
      text-shadow: 0.2rem 0.2rem 0.3rem fade(@secondary-dark, 20%);
...
.first-section {
  ...
  width: 100vw;
  color: #fff;
  background: url("../assets/background-landing.jpg") no-repeat center center
    fixed;
  ...
  .floated-content-section {
    ...
    .title {
      margin-bottom: 12px;
      text-shadow: 0.3rem 0.5rem 0.5rem fade(@secondary-dark, 20%);
    }
    ...
    .subtitle {
      ...
      margin-top: 16px;
      max-width: 13vw;
      text-shadow: 0.1rem 0.1rem 0.1rem fade(@secondary-dark, 20%);
    }
  }
  ...
  .sticky-helper {
    ...
    .central-box-wrapper {
      ...
      border-image-source: linear-gradient(
        ...
        darken(@secondary, 33%),
        @secondary-light,
        darken(@secondary-light, 33%)
      );
      border-image-slice: 10;
      box-shadow: 0 0 0.1rem 0.05rem fade(@secondary-dark, 20%);
      text-align: center;
